/*! $ Migrate v1.2.1 | (c) 2005, 2013 $ Foundation, Inc. and other contributors | jquery.org/license */
import $ from "jquery";

$.migrateMute === void 0 && ($.migrateMute = !0),
  (function(e, t, n) {
    function r(n) {
      var r = t.console;
      i[n] ||
    ...
    (e.migrateWarnings = []),
      ...
      "BackCompat" === document.compatMode &&
        r("$ is not compatible with Quirks Mode");
    ...
    a(e, "attrFn", o || {}, "$.attrFn is deprecated"),
      (e.attr = function(t, a, i, u) {
        var c = a.toLowerCase(),
          g = t && t.nodeType;
        return u &&
          (4 > s.length && r("$.fn.attr( props, pass ) is deprecated"),
      ...
      (e.attrHooks.value = {
        get: function(e, t) {
          ...
          return "button" === n
            ...
            : ("input" !== n &&
                "option" !== n &&
                r("$.fn.attr('value') no longer gets properties"),
              t in e ? e.value : null);
        },
        set: function(e, t) {
          ...
          return "button" === a
            ...
            : ("input" !== a &&
                "option" !== a &&
                r("$.fn.attr('value', val) no longer sets properties"),
              (e.value = t),
              n);
        },
      });
    ...
    (e.fn.init = function(t, n, a) {
      ...
      (e.parseJSON = function(e) {
        return e || null === e
          ...
          : (r("$.parseJSON requires a valid JSON string"), null);
      }),
      ...
      e.browser ||
        ...
        (e.browser = h)),
      a(e, "browser", e.browser, "$.browser is deprecated"),
      (e.sub = function() {
        function t(e, n) {
    ...
    e.fn.data = function(t) {
      ...
      return !o ||
        ...
        : (r("Use of $.fn.data('events') is deprecated"), i);
    };
    var j = /\/(java|ecma)script/i,
      w = e.fn.andSelf || e.fn.addBack;
    (e.fn.andSelf = function() {
      return (
        r("$.fn.andSelf() replaced by $.fn.addBack()"),
    ...
    e.event.props &&
      ...
      e.event.dispatch &&
        a(
          ...
          "handle",
          e.event.dispatch,
          "$.event.handle is undocumented and deprecated"
        ),
      ...
      (e.fn.toggle = function(t, n) {
        ...
        r("$.fn.toggle(handler, handler...) is deprecated");
        var a = arguments,
          i = t.guid || e.guid++,
          o = 0,
          s = function(n) {
